        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostingCount = table.Column<int>(type: "INTEGER", nullable: false),
                    AvgSalaryMin = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    AvgSalaryMax = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    SnapshotDate = table.Column<DateOnly>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DemandSnapshots", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalaryMin = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: true),
                    SalaryMax = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: true),
